...
SERVICES = {
    "main_backend": {"port": 8000, "name": "Main Backend API", "url": "http://localhost:8000"},
    ...
    "gosellr": {"port": 4005, "name": "GoSellr Service", "url": "http://localhost:4005"},
    "wallet": {"port": 5001, "name": "Wallet Service", "url": "http://localhost:5001"},
    "ai_agent": {"port": 4007, "name": "AI Agent", "url": "http://localhost:4007"},
    "assistant": {"port": 4008, "name": "EHB Assistant", "url": "http://localhost:4008"},
